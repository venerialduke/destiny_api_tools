...
## Endpoint Details
- **HTTP Method:** POST
- **Path:** `/FireteamFinder/Lobby/UpdateSettings/{lobbyId}/{destinyMembershipType}/{destinyMembershipId}/{destinyCharacterId}/`
- **Operation ID:** `FireteamFinder.UpdateLobbySettings`
- **Tags:** FireteamFinder
- **Deprecated:** false
...
| lobbyId | integer (int64) | Yes | The ID of the lobby to update. |
...
```json
{
  ...
  "properties": {
    "Response": {
      "$ref": "#/definitions/FireteamFinder.DestinyFireteamFinderUpdateLobbySettingsResponse"
    },
    "ErrorCode": {
      "format": "int32",
      "type": "integer",
