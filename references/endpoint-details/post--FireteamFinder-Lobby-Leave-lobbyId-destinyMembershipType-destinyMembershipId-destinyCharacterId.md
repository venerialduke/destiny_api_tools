...
- **Operation ID:** `FireteamFinder.LeaveLobby`
- **Tags:** FireteamFinder
- **Deprecated:** false
...
| lobbyId | integer (int64) | Yes | The ID of the lobby to leave. |
...
### Request
```http
POST /FireteamFinder/Lobby/Leave/{lobbyId}/{destinyMembershipType}/{destinyMembershipId}/{destinyCharacterId}/
```
