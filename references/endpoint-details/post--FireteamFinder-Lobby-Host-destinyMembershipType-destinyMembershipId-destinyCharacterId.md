...
## Endpoint Details
- **HTTP Method:** POST
- **Path:** `/FireteamFinder/Lobby/Host/{destinyMembershipType}/{destinyMembershipId}/{destinyCharacterId}/`
- **Operation ID:** `FireteamFinder.HostLobby`
- **Tags:** FireteamFinder
- **Deprecated:** false
...
```json
{
  ...
  "properties": {
    "Response": {
      "$ref": "#/definitions/FireteamFinder.DestinyFireteamFinderHostLobbyResponse"
    },
    "ErrorCode": {
      "format": "int32",
      "type": "integer",
