...
## Endpoint Details
- **HTTP Method:** GET
- **Path:** `/FireteamFinder/Lobby/{lobbyId}/{destinyMembershipType}/{destinyMembershipId}/{destinyCharacterId}/`
- **Operation ID:** `FireteamFinder.GetLobby`
- **Tags:** FireteamFinder
- **Deprecated:** false
...
| lobbyId | integer (int64) | Yes | The ID of the lobby to retrieve. |
...
### Request
```http
GET /FireteamFinder/Lobby/{lobbyId}/{destinyMembershipType}/{destinyMembershipId}/{destinyCharacterId}/
```
