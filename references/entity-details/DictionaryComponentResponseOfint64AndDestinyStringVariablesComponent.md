...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint64AndDestinyStringVariablesComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint64anddestinystringvariablescomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint64AndDestinyStringVariablesComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
