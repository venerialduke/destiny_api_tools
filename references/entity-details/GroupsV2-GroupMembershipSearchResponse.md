...
## Entity Information
- **Entity Name**: GroupsV2.GroupMembershipSearchResponse
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
API entity for groupmembershipsearchresponse operations.
...
### JavaScript
```javascript
// Example GroupsV2.GroupMembershipSearchResponse object
const example = {
  results: [],
  totalResults: 123,
  hasMore: true,
