...
## Entity Information
- **Entity Name**: SearchResultOfGroupPotentialMembership
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
API entity for searchresultofgrouppotentialmembership operations.
...
### JavaScript
```javascript
// Example SearchResultOfGroupPotentialMembership object
const example = {
  results: [],
  totalResults: 123,
  hasMore: true,
