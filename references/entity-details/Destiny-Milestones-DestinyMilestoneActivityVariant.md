...
## Entity Information
- **Entity Name**: Destiny.Milestones.DestinyMilestoneActivityVariant
...
|---------------|------|-------------|----------|
| activityHash | integer (uint32) | The hash for the specific variant of the activity related to this milestone. You can pull more detailed static info from the DestinyActivityDefinition, such as difficulty level. | No |
| completionStatus | object | An OPTIONAL component: if it makes sense to talk about this activity variant in terms of whether or not it has been completed or what progress you have made in it, this will be returned. Otherwise, this will be NULL. | No |
...
### JavaScript
```javascript
// Example Destiny.Milestones.DestinyMilestoneActivityVariant object
const example = {
  activityHash: 123,
...
- **Destiny.Milestones.DestinyMilestoneActivityCompletionStatus**: Referenced in this entity
