...
## Entity Information
- **Entity Name**: SearchResultOfGroupEditHistory
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
API entity for searchresultofgroupedithistory operations.

## Properties

| Property Name | Type | Description | Required |
|---------------|------|-------------|----------|
| results | Array[GroupsV2.GroupEditHistory] |  | No |
...
### JavaScript
```javascript
// Example SearchResultOfGroupEditHistory object
const example = {
  results: [],
  totalResults: 123,
  hasMore: true,
...
## Related Entities
- **GroupsV2.GroupEditHistory**: Referenced in this entity
  ...
  "SearchResultOfGroupEditHistory":   {
      ...
      "properties": {
          "results": {
              "type": "array",
              "items": {
                  "$ref": "#/definitions/GroupsV2.GroupEditHistory"
              }
          },
          "totalResults": {
              "format": "int32",
