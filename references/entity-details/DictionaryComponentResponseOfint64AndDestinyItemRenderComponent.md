...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint64AndDestinyItemRenderComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint64anddestinyitemrendercomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint64AndDestinyItemRenderComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
