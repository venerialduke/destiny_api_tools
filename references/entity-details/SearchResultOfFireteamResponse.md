...
## Entity Information
- **Entity Name**: SearchResultOfFireteamResponse
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
API entity for searchresultoffireteamresponse operations.

## Properties

| Property Name | Type | Description | Required |
|---------------|------|-------------|----------|
| results | Array[Fireteam.FireteamResponse] |  | No |
...
### JavaScript
```javascript
// Example SearchResultOfFireteamResponse object
const example = {
  results: [],
  totalResults: 123,
  hasMore: true,
...
## Related Entities
- **Fireteam.FireteamResponse**: Referenced in this entity
