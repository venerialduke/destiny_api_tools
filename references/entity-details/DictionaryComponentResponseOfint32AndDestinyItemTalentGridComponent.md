...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint32AndDestinyItemTalentGridComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint32anddestinyitemtalentgridcomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint32AndDestinyItemTalentGridComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
