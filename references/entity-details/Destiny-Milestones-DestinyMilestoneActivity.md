...
## Entity Information
- **Entity Name**: Destiny.Milestones.DestinyMilestoneActivity
...
|---------------|------|-------------|----------|
| activityHash | integer (uint32) | The hash of an arbitrarily chosen variant of this activity. We'll go ahead and call that the "canonical" activity, because if you're using this value you should only use it for properties that are common across the variants: things like the name of the activity, it's location, etc... Use this hash to look up the DestinyActivityDefinition of this activity for rendering data. | No |
...
- **Destiny.Milestones.DestinyMilestoneActivityVariant**: Referenced in this entity
  ...
  "Destiny.Milestones.DestinyMilestoneActivity":   {
      ...
      "properties": {
          ...
          "variants": {
              ...
              "type": "array",
              "items": {
                  "$ref": "#/definitions/Destiny.Milestones.DestinyMilestoneActivityVariant"
              }
          }
      }
  }
