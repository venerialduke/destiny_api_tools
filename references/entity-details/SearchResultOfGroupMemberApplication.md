...
## Entity Information
- **Entity Name**: SearchResultOfGroupMemberApplication
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
API entity for searchresultofgroupmemberapplication operations.

## Properties

| Property Name | Type | Description | Required |
|---------------|------|-------------|----------|
| results | Array[GroupsV2.GroupMemberApplication] |  | No |
...
### JavaScript
```javascript
// Example SearchResultOfGroupMemberApplication object
const example = {
  results: [],
  totalResults: 123,
  hasMore: true,
...
## Related Entities
- **GroupsV2.GroupMemberApplication**: Referenced in this entity
  ...
  "SearchResultOfGroupMemberApplication":   {
      ...
      "properties": {
          "results": {
              "type": "array",
              "items": {
                  "$ref": "#/definitions/GroupsV2.GroupMemberApplication"
              }
          },
          "totalResults": {
              "format": "int32",
