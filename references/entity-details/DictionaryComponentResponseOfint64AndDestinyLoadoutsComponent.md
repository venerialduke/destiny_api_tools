...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint64AndDestinyLoadoutsComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint64anddestinyloadoutscomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint64AndDestinyLoadoutsComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
