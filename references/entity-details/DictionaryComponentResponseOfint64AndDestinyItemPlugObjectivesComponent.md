...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint64AndDestinyItemPlugObjectivesComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint64anddestinyitemplugobjectivescomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint64AndDestinyItemPlugObjectivesComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
