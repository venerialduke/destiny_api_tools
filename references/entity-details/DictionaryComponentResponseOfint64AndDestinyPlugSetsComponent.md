...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint64AndDestinyPlugSetsComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint64anddestinyplugsetscomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint64AndDestinyPlugSetsComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
