...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint32AndDestinyItemRenderComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint32anddestinyitemrendercomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint32AndDestinyItemRenderComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
