...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint32AndDestinyItemPlugObjectivesComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint32anddestinyitemplugobjectivescomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint32AndDestinyItemPlugObjectivesComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
