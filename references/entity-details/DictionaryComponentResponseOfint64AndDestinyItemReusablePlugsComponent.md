...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint64AndDestinyItemReusablePlugsComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint64anddestinyitemreusableplugscomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint64AndDestinyItemReusablePlugsComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
