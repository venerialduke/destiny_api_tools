...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint64AndDestinyItemTalentGridComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint64anddestinyitemtalentgridcomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint64AndDestinyItemTalentGridComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
