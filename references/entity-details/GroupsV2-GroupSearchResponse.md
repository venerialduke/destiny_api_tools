...
## Entity Information
- **Entity Name**: GroupsV2.GroupSearchResponse
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
API entity for groupsearchresponse operations.

## Properties

| Property Name | Type | Description | Required |
|---------------|------|-------------|----------|
| results | Array[GroupsV2.GroupV2Card] |  | No |
...
### JavaScript
```javascript
// Example GroupsV2.GroupSearchResponse object
const example = {
  results: [],
  totalResults: 123,
  hasMore: true,
...
## Related Entities
- **GroupsV2.GroupV2Card**: Referenced in this entity
