...
## Entity Information
- **Entity Name**: DictionaryComponentResponseOfint64AndDestinyCharacterRenderComponent
- **Entity Type**: Object Schema
- **Base Type**: object

## Description
Destiny API entity representing dictionarycomponentresponseofint64anddestinycharacterrendercomponent data.
...
### JavaScript
```javascript
// Example DictionaryComponentResponseOfint64AndDestinyCharacterRenderComponent object
const example = {
  data: null,
  privacy: 123,
  disabled: true,
